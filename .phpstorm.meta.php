...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'payment.stripe.publishable_key' => 'string',
            'payment.stripe.secret_key' => 'string',
            'payment.stripe.webhook_secret' => 'string',
            'payment.paypal.client_id' => 'string',
            'payment.paypal.secret' => 'string',
            'payment.paypal.mode' => 'string',
            'payment.paypal.webhook_id' => 'string',
            'payment.square.application_id' => 'string',
            'payment.square.access_token' => 'string',
            'payment.square.location_id' => 'string',
            'payment.square.webhook_secret' => 'string',
            'payment.square.webhook_url' => 'string',
            'payment.square.mode' => 'string',
...
'payment.stripe.publishable_key','payment.stripe.secret_key','payment.stripe.webhook_secret','payment.paypal.client_id','payment.paypal.secret',
'payment.paypal.mode','payment.paypal.webhook_id','payment.square.application_id','payment.square.access_token','payment.square.location_id',
'payment.square.webhook_secret','payment.square.webhook_url','payment.square.mode','queue.default','queue.connections.sync.driver',
...
'DB_PASSWORD','SANCTUM_STATEFUL_DOMAINS','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT',
'SESSION_PATH','SESSION_SECURE_COOKIE','SESSION_SAME_SITE','BROADCAST_CONNECTION','FILESYSTEM_DISK',
...
'VITE_APP_NAME','STRIPE_PUBLISHABLE_KEY','STRIPE_SECRET_KEY','STRIPE_WEBHOOK_SECRET','PAYPAL_CLIENT_ID',
'PAYPAL_SECRET','PAYPAL_MODE','PAYPAL_WEBHOOK_ID','PAYPAL_RETURN_BASE_URL','SQUARE_APPLICATION_ID',
'SQUARE_ACCESS_TOKEN','SQUARE_LOCATION_ID','SQUARE_MODE','SQUARE_WEBHOOK_SECRET','SQUARE_WEBHOOK_URL',);
