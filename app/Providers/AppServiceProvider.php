...
use App\Listeners\Activity\LogLoginFailure;
use App\Listeners\Activity\LogLoginSuccess;
use App\Listeners\Activity\LogLogout;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Event::listen(\Illuminate\Auth\Events\Login::class, LogLoginSuccess::class);
        Event::listen(\Illuminate\Auth\Events\Failed::class, LogLoginFailure::class);
